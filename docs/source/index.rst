...
Welcome to Chatterbox's documentation!
======================================

**Chatterbox** is a simple, terminal-based chat application with user authentication and private messaging, built with Python sockets.
